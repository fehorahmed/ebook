                        ...
                        <table class="table table-flush dataTable-table" id="users_table">
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%" class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Email</th>
                                ...
                                @foreach ($user as $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-center text-xs font-weight-medium mb-0">{{ $item->name }}</p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                        ...
                                        <td class="align-middle text-center">
                                            <span>
                                            <img src="{{ asset('upload/avatar_images/'.$item->avatar) }}" alt="" height="40">
                                            </span>
                                        </td>
                                        <td>
                                            <a class="btn waves-effect waves-light btn-info btn-sm-custom ml-1 mb-0" title="Edit User Details" href="{{ route('users.show', $item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                            <a class="btn waves-effect waves-light btn-success btn-sm-custom ml-1  mb-0" title="Edit User Details" href="{{ route('users.edit', $item->id) }}">
                                                <i class="fa fa-edit"></i></i>
                                            </a>
                                            <button class="btn waves-effect waves-light btn-danger btn-sm-custom ml-1 mb-0 text-white deleteItem" title="Delete User" data-id="{{$item->id}}">
