            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form action="{{ route('articles.update', $article->id) }}" enctype="multipart/form-data" method="POST" data-parsley-validate data-parsley-focus="first">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title') ?? $article->title }}" placeholder="Enter Title" required=""/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" id="status" name="status" required>
                                            <option value="publish" {{ $article->status == "publish" ? 'selected' : null }}>Publish</option>
                                            <option value="save" {{ $article->status == "save" ? 'selected' : null }}>Saved</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"id="keywords" name="keywords" value="{{ old('keywords') ?? $article->keywords }}" placeholder="keyword1, keyword2, keyword3 ..."/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        data-default-file="{{ $article->image != null ? asset('uploaded_files/images/articles/'.$article->image) : null }}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
