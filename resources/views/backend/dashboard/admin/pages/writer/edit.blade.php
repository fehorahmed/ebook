                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $writer->name ?? '' ) }}" id="name" class="form-control">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="1" @if($writer->status == 1) selected @endif> Active</option>
                                        <option value="0" @if($writer->status == 0) selected @endif> Inactive</option>
                                        @error('status')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </select>
                       ...
                       <div class="row">
                        <div class="col-md-4 mt-3">
                            <div class="form-group">
                                ...
                                <a href="{{ route('writers.index') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                       </div>
                    </form>
