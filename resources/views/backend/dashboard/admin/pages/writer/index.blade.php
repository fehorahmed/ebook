        ...
        <div class="card mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-5 my-auto text-end">
                        <div class="float-lg-end">
                            <a href="{{ route('writers.create') }}" class="btn btn-info float-right">Add new</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive p-0">
                ...
                @foreach ($writers as $item)
                    ...
                    <td>
                        <a class="btn waves-effect waves-light btn-success btn-sm-custom ml-1" title="Edit User Details" href="{{ route('writers.edit', $item->id) }}">
                        ...
                        <form id="deleteForm{{$item->id}}" action="{{route('writers.destroy', [$item->id])}}" method="post" style="display:none">
                            @csrf
                            @method('delete')
