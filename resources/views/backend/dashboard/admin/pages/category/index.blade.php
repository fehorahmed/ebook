        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col-lg-6 col-7">
                        <h6>Book Category List</h6>
                    </div>
                    <div class="col-lg-6 col-5 my-auto text-end">
                        <div class="float-lg-end">
                            <a href="{{ route('book-category.create') }}" class="btn btn-info float-right">Add new</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive p-0">
                ...
                @foreach ($categories as $item)
                    ...
                    <td>
                        <a class="btn waves-effect waves-light btn-success btn-sm-custom ml-1" title="Edit User Details" href="{{ route('book-category.edit', $item->id) }}">
                        ...
                        <form id="deleteForm{{$item->id}}" action="{{route('book-category.destroy', [$item->id])}}" method="post" style="display:none">
                            @csrf
                            @method('delete')
