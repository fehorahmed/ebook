                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('top_title', $studioHeader->top_title ?? '' ) }}" id="name" class="form-control">
                                    @error('name')
                       ...
                       <div class="row">
                        <div class="col-md-4 mt-3">
                            <div class="form-group">
                                ...
                                <a href="{{ route('book-category.index') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                       </div>
                    </form>
