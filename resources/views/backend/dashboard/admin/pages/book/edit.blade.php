...
<section>
                ...
                <div class="col-md-12">
                    <form action="{{ route('book.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="status">Writer <span class="text-danger">*</span></label>
                                    <select class="form-control" id="writer_id" name="writer_id">
                                        <option value="" selected>--Select Writer--</option>
                                        @foreach ($writers as $writer)
                                            <option value="{{ $writer->id }}" @if($book->writer_id == $writer->id) selected @endif>{{ $writer->name ?? '' }}</option>
                                        @endforeach
                                        @error('writer_id')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" id="image" data-height="100" class="form-control dropify" data-default-file="{{ isset($book->image) ? asset('upload/book_image/'.$book->image) : null }}">
                                    @error('image')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="summernote" name="short_description">{{ $book->description ?? '' }}</textarea>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                @if (old('content_name') != null && sizeof(old('content_name')) > 0)
                                    ...
                                    @endforeach
                                @else
                                    @foreach ($book->bookPageContent as $item)
                                    {{-- {{ dd($book->bookPageContent) }} --}}
                                        <tr class="product-item">
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" name="content_name[]" class="form-control content_name" placeholder="Enter Title Name" value="{{ $item->content_name ?? '' }}">
                                                </div>
                                            </td>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="product-container-two">
                                    ...
                                    <tr class="product-item-two">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="number" name="ad_count" value="{{old('ad_count', $book->ad_count ?? '')}}" class="form-control ad_count" placeholder=" Total Count">
                                            </div>
                                        </td>
                                         <td>
                                            <div class="form-group">
                                                <input type="number" name="ad_coin" value="{{old('ad_coin', $book->ad_coin ?? '')}}" class="form-control ad_coin" placeholder=" Total Coin">
                                            </div>
                                        </td>
                                    </tr>
    ...
    <template id="template-product">
        <tr class="product-item">
            ...
            <td>
                <div class="form-group">
                    <textarea class="summernote" rows="5" cols="70" name="description[]"></textarea>
                </div>
            </td>
            <td class="text-center">
                <a role="button" class="btn btn-danger btn-sm btn-remove">X</a>
