                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="0" @if(old('status') == 'inactive') selected @endif> Inactive</option>
                                        @error('status')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </select>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="product-container-two">
                                    ...
                                    <tr class="product-item-two">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="number" name="ad_count" value="{{old('ad_count')}}" class="form-control ad_count" placeholder=" Total Count">
                                                @error('ad_count')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                         ...
                                         <td>
                                            <div class="form-group">
                                                <input type="number" name="ad_coin" value="{{old('ad_coin')}}" class="form-control ad_coin" placeholder=" Total Coin">
                                                @error('ad_coin')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
