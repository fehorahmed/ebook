                ...
                function (t, e, s) {
                    ...
                    class l {
                                    ...
                                    (i = e.cloneNode(!1)),
                                        ...
                                        null !== e.searchIndex &&
                                            ...
                                            (i.searchIndex = a.searchIndex =
                                                e.searchIndex),
                                        t.forEach((t) => {
                                            (h = e.cells[t].cloneNode(!0)),
                                                (h.data = e.cells[t].data),
                                                i.appendChild(h),
                                                l.hiddenColumns.includes(t) ||
                                                    ((h = e.cells[t].cloneNode(
                                                        !0
                                                    )),
                                                    (h.data = e.cells[t].data),
                                                    a.appendChild(h));
                        ...
                        sort(e, s, i) {
                            ...
                            if (
                                a.hasHeadings &&
                                (e < 0 || e > a.headings.length)
                            )
                                return !1;
                            const n =
                                a.options.filters &&
                                a.options.filters[a.headings[e].textContent];
                            if (n && 0 !== n.length)
                            ...
                            if ("date" === u.getAttribute("data-type")) {
                                let e = !1;
                                u.hasAttribute("data-format") &&
                                    (e = u.getAttribute("data-format")),
                                    p.push(
                                        Promise.resolve()
                                            .then(function () {
                            ...
                            Promise.all(p).then((t) => {
                                ...
                                Array.from(r).forEach((t) => {
                                    ...
                                    "desc" == s
                                        ? ((p = h(o, -1)),
                                          (f = h(l, -1)),
                                          u.classList.remove("asc"),
                                          u.classList.add("desc"))
                                        : ((p = h(l, 1)),
                                          (f = h(o, 1)),
                                          u.classList.remove("desc"),
                                          u.classList.add("asc")),
                                    a.lastTh &&
                                        u != a.lastTh &&
                        ...
                        renderPager() {
                            if ((n(this.pagers), this.totalPages > 1)) {
                                ...
                                this.options.firstLast &&
                                    e.appendChild(
                                        r(t, 1, this.options.firstText)
                                    ),
                                    this.options.nextPrev &&
                                        e.appendChild(
                                            r(t, s, this.options.prevText)
                                        );
                                let n = this.links;
